...
std::list<llvm::StringRef> BlueKitchen_API = {
    /// ad_parser.h
    //@{
    "ad_iterator_init", 
    "ad_iterator_has_more",
    "ad_iterator_next", 
    "ad_iterator_get_data_type",
    "ad_iterator_get_data_len",
    "ad_iterator_get_data",
    "ad_data_contains_uuid16",
    "ad_data_contains_uuid128",
    //@}
    ...
    "gap_set_link_supervision_timeout",
    "gap_enable_link_watchdog",
    ...
    "gap_set_secure_connections_only_mode",
    ...
    "gap_set_required_encryption_key_size",
    ...
    "gap_set_page_scan_type",
    "gap_set_page_timeout",
    "gap_set_scan_params",
    ...
    "gap_random_address_set_update_period",
    ...
    "gap_extended_advertising_set_params",
    "gap_extended_advertising_get_params",
    "gap_periodic_advertising_set_params",
    "gap_periodic_advertising_get_params",
    ...
    "gap_extended_advertising_start",
    "gap_extended_advertising_stop",
    "gap_periodic_advertising_start",
    "gap_periodic_advertising_stop",
    "gap_extended_advertising_remove",
    ...
    "gap_pin_code_negative",
    "gap_ssp_passkey_response",
    "gap_ssp_passkey_negative",
    "gap_ssp_confirmation_response",
    "gap_ssp_confirmation_negative",
    "gap_ssp_generate_oob_data",
    "gap_ssp_remote_oob_data",
    "gap_ssp_io_capabilities_response",
    "gap_ssp_io_capabilities_negative",
    "gap_send_link_key_response",
    "gap_sniff_mode_enter",
    "gap_sniff_mode_exit",
    "gap_sniff_subrating_configure",
    "gap_qos_set",
